...
var player, playerAnimation, playerImg, jungle, jungleImg, ground;
...
function setup() {
  ...
  player.addImage("changes", playerImg);
  player.scale = 0.10;
...
function draw() {
  ...
  if (player.isTouching(obstaclesGroup))
    ...
    obstaclesGroup.lifetie = -1;
    jungle.velocityX = 0;
    player.changeAnimation("changes",playerImg);
  }
